    ...
    <div className='footer-container'>
      <section className='footer-subscription'>
        <p className='footer-subscription-heading'>
          Join the New Travelling Experience With New Vibes
        </p>
      ...
      <section class='social-media'>
        <div class='social-media-wrap'>
          ...
          <div
              ...
              <a href="https://www.facebook.com/profile.php?id=100016560079470" rel="noopener noreferrer" target="_blank">
                <i style={{ color: '#4267B2' }} class='fab fa-facebook' aria-label='Facebook' />
              </a>
            </div>
            <div
              class='social-icon-link instagram'>
              <a href="https://www.instagram.com/shivi_agr2901/" rel="noopener noreferrer" target="_blank">
           ...
           <div
            ...
            <div
              ...
              <a href="https://www.linkedin.com/in/shivani-goel-8a8b51170/" rel="noopener noreferrer" target="_blank">
